...
- ✅ **YAML:** `sx9_entities.yaml` (main output)
- ✅ **JSON:** `sx9_entities.json` (compatibility)
- ❌ **TOML:** NOT currently saved by DSL pipeline

### **Where TOML IS Generated:**
TOML files ARE generated by:
- ✅ `match_tools_to_ctas_tasks.py` - Generates `tools_tasks_matching.toml`
- ✅ Other matching/export scripts
...
- **Cost:** **$177.66** (3x H100 @ $3.29/hr × 18 hrs)
...
|--------|----------|---------|-----------|
| **Lambda Labs H100 (Parallel)** | $177.66 | $13.50 | **$191.16** ⭐ |
