(module
  ;; CTAS Task Microkernel: Multi-Jurisdiction Contingent Assembly
  ...
  ;; Task metadata
  (data (i32.const 0) "uuid-008-000-002")
  (data (i32.const 100) "Multi-Jurisdiction Contingent Assembly")
