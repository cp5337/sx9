...
/// CTAS Task Binary: Exploiting Legal Loopholes
/// Task ID: uuid-010-007-001
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Exploiting Legal Loopholes");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-010-007-001", target])
        .spawn();
}
