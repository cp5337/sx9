...
/// CTAS Task Binary: Islamic Terror Cell Activation
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Islamic Terror Cell Activation");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-004-001-020", target])
        .spawn();
}
