...
/// CTAS Task Binary: Execution of Cyber Physical Attacks
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Execution of Cyber Physical Attacks");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-007-000-001", target])
        .spawn();
}
