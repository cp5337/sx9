...
/// CTAS Task Binary: Exploiting Police Interactions
/// Task ID: uuid-011-003-001
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Exploiting Police Interactions");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-011-003-001", target])
        .spawn();
}
