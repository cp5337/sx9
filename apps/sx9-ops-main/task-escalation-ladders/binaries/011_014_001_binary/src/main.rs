...
/// CTAS Task Binary: Border Crossing Counter-Surveillance
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Border Crossing Counter-Surveillance");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-011-014-001", target])
        .spawn();
}
