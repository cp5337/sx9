...
/// CTAS Task Binary: Unwitting Accomplice Manipulation
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Unwitting Accomplice Manipulation");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-001-004-001", target])
        .spawn();
}
