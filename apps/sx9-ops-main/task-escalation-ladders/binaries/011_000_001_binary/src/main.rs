...
/// CTAS Task Binary: Transnational Cartel Operations
...
async fn main() {
    ...
    info!("🎯 CTAS Task: Transnational Cartel Operations");
    info!("📍 Target: {}", target);
...
fn escalate_to_container(target: &str) {
    ...
    let _ = Command::new("docker")
        .args(&["run", "--rm", "ctas7/kali-tools:7.3.1", "uuid-011-000-001", target])
        .spawn();
}
