...
use crate::dsl::hash_extractor::{HashComponents, extract_all_components, hash_to_unicode, HashComponent};
...
impl UnicodeEmitter {
    ...
    pub fn emit_from_hash(&self, operational_hash: &str) -> DSLResult<Vec<char>> {
        let components = extract_all_components(operational_hash)?;
